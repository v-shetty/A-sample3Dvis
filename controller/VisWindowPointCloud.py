...
class VisWindowPointCloud(QWidget):
    """
    ...
    def __init__(self):
        ...
        Rangebar = ColorBarItem(interactive=False , cmap=colormap,values=(0, (globalfile.rangemax+0.9)) , label = "meters(m)") #0, globalfile.rangemax
        ...
        #
        cmap = cm.get_cmap("viridis")
        Intensitybar = ColorBarItem(interactive=False, cmap=colormap,values=(0, 32),label = "Linear Magnitude", colorMap=cmap, )
